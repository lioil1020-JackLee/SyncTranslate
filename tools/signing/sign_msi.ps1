# Sign a SyncTranslate MSI with an installed code-signing certificate.
...
Write-Host "[verify] $MsiPath"
Invoke-Signtool @("verify", "/pa", "/v", $MsiPath)
Write-Host "[done] MSI signature verified: $MsiPath"
