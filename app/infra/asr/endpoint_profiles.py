...
PROFILES: dict[str, EndpointProfile] = {
    ...
    "headset": EndpointProfile(
        name="headset",
        partial_interval_ms=350,
        min_partial_audio_ms=200,
        soft_final_audio_ms=2800,
        soft_endpoint_finalize_audio_ms=900,
        speech_end_finalize_audio_ms=800,
        pre_roll_ms=150,
        preferred_vad_backend="silero",
        description="Low-latency profile for close-talking headset microphone.",
    ),
