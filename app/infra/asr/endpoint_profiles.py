...
class EndpointProfile:
    ...
    def to_worker_kwargs(self) -> dict[str, Any]:
        ...
        return {
            ...
            "soft_endpoint_finalize_audio_ms": self.soft_endpoint_finalize_audio_ms,
            "speech_end_finalize_audio_ms": self.speech_end_finalize_audio_ms,
...
PROFILES: dict[str, EndpointProfile] = {
    "default": EndpointProfile(
        name="default",
        partial_interval_ms=420,
        min_partial_audio_ms=320,
        soft_final_audio_ms=3200,
    ...
    "meeting_room": EndpointProfile(
        name="meeting_room",
        partial_interval_ms=620,
        min_partial_audio_ms=480,
        soft_final_audio_ms=4600,
        soft_endpoint_finalize_audio_ms=1900,
        speech_end_finalize_audio_ms=1600,
        pre_roll_ms=360,
        preferred_vad_backend="silero",
        description="Conservative subtitle profile for long-form multi-speaker meeting audio.",
    ),
    "headset": EndpointProfile(
        name="headset",
        partial_interval_ms=360,
        min_partial_audio_ms=280,
    ...
    "max_accuracy": EndpointProfile(
        name="max_accuracy",
        partial_interval_ms=760,
        min_partial_audio_ms=560,
    ...
    "turn_taking": EndpointProfile(
        ...
        soft_final_audio_ms=1900,
        soft_endpoint_finalize_audio_ms=760,
        speech_end_finalize_audio_ms=620,
        pre_roll_ms=140,
        preferred_vad_backend="silero",
        description="Low-latency profile for short, back-and-forth conversation turns.",
    ),
}
