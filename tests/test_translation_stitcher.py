"""Unit tests for TranslationStitcher behaviour.

Covers: sliding window context, de-dup cache, partial gate, adaptive tuning.
Separated from test_translation_manager_profiles.py which focuses on
profile routing and ASR correction integration.
"""
...
class TranslationStitcherTests(unittest.TestCase):
